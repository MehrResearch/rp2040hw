...
DMA_CTRL_FIELDS = {
    ...
    "CHAIN_TO":         11 << BF_POS | (5 if RP2350 else 4) << BF_LEN | BFUINT32, # Channel to chain to after completion (4 bits RP2040, 5 bits RP2350)
...
DMA_SNIFF_CTRL_FIELDS = {
    ...
    "DMACH":            1 << BF_POS | (5 if RP2350 else 4) << BF_LEN | BFUINT32,  # DMA channel for sniffer to observe (4 bits RP2040, 5 bits RP2350)
...
DMA_FIELDS = {
    # Channels (12 on RP2040, 16 on RP2350)
    "CH":               (0x000 | ARRAY, 16 if RP2350 else 12, DMA_CHANNEL_FIELDS),
    # Interrupt Registers
    ...
    # Debug Registers (12 on RP2040, 16 on RP2350)
    "CH_DBG":           (0x800 | ARRAY, 16 if RP2350 else 12, DMA_DEBUG_CHANNEL_FIELDS)
}
